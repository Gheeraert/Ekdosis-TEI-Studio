...
// WebTV Université de Rouen
tarteaucitron.services.webtvrouen = {
    "key": "webtvrouen",
    "type": "video",
    "name": "WebTV Université de Rouen",
    "uri": "https://docs.google.com/document/d/1tpVclj4QBoAq1meSZgYrpNECwp7dbmb_IhICY3sTl9c/edit",
    "needConsent": true,
    "cookies": [],
    "js": function () {
        "use strict";
        tarteaucitron.fallback(['webtvrouen_player'], function (x) {
            var frame_url = 'https://webtv.univ-rouen.fr/permalink/' + x.getAttribute("videoID") + '/iframe/',
                width = x.getAttribute("width"),
                height = x.getAttribute("height");
    ...
    "fallback": function () {
        "use strict";
        tarteaucitron.fallback(['webtvrouen_player'], function (elem) {
            return tarteaucitron.engage('webtvrouen');
        });
    }
  };
