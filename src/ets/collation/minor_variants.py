...
VARIANT_ANA_CATEGORIES: dict[str, str] = {
    ...
    "accent_only": "Variation limitée à l’accentuation.",
    "apostrophe": "Variation d’apostrophe.",
    "case_only": "Variation limitée aux majuscules et minuscules.",
    "damerau_metathesis": "Métathèse graphique probable.",
    "double_consonant": "Variation de consonne double.",
    "final_t_before_s": "Variation de t étymologique avant s final.",
    "final_zx_s": "Variation graphique finale z/x/s.",
    "historic_graphic_key_identity": "Identité après normalisation graphique historique.",
    "historic_spelling": "Variation de graphie historique.",
    "i_j": "Variation graphique entre i et j.",
    "levenshtein_alert": "Proximité graphique probable.",
    "ligature_or_long_s": "Variation de ligature ou de s long.",
    "literal_identity": "Identité littérale.",
    "punctuation_only": "Variation limitée à la ponctuation.",
    "punctuation_removed_for_graphic_key": "Ponctuation neutralisée pour la comparaison graphique.",
    "spacing_or_hyphen": "Variation d’espace ou de trait d’union.",
    "spacing_or_hyphen_only": "Variation limitée aux espaces ou aux traits d’union.",
