...
def render_publication_pdf_master(config: SitePublicationDialogConfig) -> str:
    lines: list[str] = [
        ...
        "% This file is an internal build artifact; TEI-to-LaTeX conversion is not implemented here.",
    ...
    if config.general_intro_tei is not None:
        lines.extend(
            [
                ...
                r"\emph{Placeholder: conversion TEI peritextuelle vers LaTeX standard a venir.}",
            ]
        )
